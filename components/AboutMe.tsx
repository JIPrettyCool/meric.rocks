...
export default function AboutMeSection() {
  ...
  return (
    <div className="bg-background/50 border border-white/10 rounded-2xl p-6 backdrop-blur-md shadow-lg hover:border-primary/20 transition-all">
      <div className="flex items-center justify-between mb-6 pb-5 border-b border-white/10">
        <div className="flex items-center gap-4">
          <div className="h-16 w-16 rounded-full bg-background/40 flex items-center justify-center border border-primary/20 shadow-sm">
